...
class EnvChecker:
    ...
    def _check_xcode(self):
        """检测Xcode是否安装（xcodebuild -version）"""
        try:
    ...
    def _print_report(self):
        ...
        for result in self.results:
            ...
            if not result['passed'] and result['install_guide']:
                print("\n  🔧 安装指引:")
                print("  {}".format(result['install_guide']))
